...
if ($_POST["titulo"] != null && $_POST["keyword"] != null && $_POST["fecha1"] != null && $_POST["fecha2"] != null) {
  ...
  if ($_POST["titulo"] != null && $_POST["keyword"] != null) {
    $titulo = $_POST["titulo"];
    $keyword = $_POST["keyword"];
    ...
    if ($_POST["titulo"] != null && $_POST["fecha1"] != null && $_POST["fecha2"] != null) {
      ...
      if ($_POST["keyword"] != null && $_POST["fecha1"] != null && $_POST["fecha2"] != null) {
        $keyword = $_POST["keyword"];
        $fecha1 = $_POST["fecha1"];
        $fecha2 = $_POST["fecha2"];
